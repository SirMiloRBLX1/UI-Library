...
do
	...
	local GUI1 = game:GetService("CoreGui"):FindFirstChild("Fluent_Library")
	if GUI1 then
		GUI1:Destroy()
	end
end
...
local function CloseOpen()
	...
	ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
		...
		TextButton.Position = UDim2.new(0.361326903, 0, 0.0858204663, 0)
		TextButton.Size = UDim2.new(0.221615717, 0, 0.0692806542, 0)
		TextButton.Font = Enum.Font.Roboto
		TextButton.Text = "Open Fluent"
...
local InterfaceManager = {} do
	InterfaceManager.Folder = "Fluent_Config"
